    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/Change-password" element={<><Header /><NavBar/><ChangePassword /><Footer /></>} />
          <Route path="/claim" element={<><Header /><Claim /><Footer /></>} />
          <Route path="/mark-exit" element={<><Header /><NavBar/><MarkExit /><Footer /></>} />
          <Route path="/claim-status" element={<><Header /><TrackClaimStatus /><Footer /></>} />
          <Route path="/annexure-k" element={<><Header /><Annexure /><Footer /></>} />
          <Route path="/contact-details" element={<><Header /><NavBar/><ChangeContactDetails /><Footer /></>} />
          ...
          <Route path="/profile" element={<><Header /><NavBar /><Profile /><Footer /></>} />
          <Route path="/service-history" element={<><Header /><Passbook /><Footer /></>} />
          <Route path="/uan-card" element={<><Header /><UANCard /><Footer /></>} />
          <Route path="/Passbook" element={<><Header /><Passbook /><Footer /></>} />
          <Route path="/e-nomination" element={<><Header /><ENomaination /><Footer /></>} />
          <Route path="/joint-declaration" element={<><Header /><JointDeclaration /><Footer /></>} />
        </Routes>
